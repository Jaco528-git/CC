...
description: 学术论文搜索与下载。当用户需要搜索学术论文、查找文献、下载论文 PDF、查询某领域/关键词/作者的研究论文、了解期刊影响因子和引用量时使用。支持中英文搜索，覆盖人文地理、社会科学及所有学术领域。每当用户提到"找论文"、"搜文献"、"下载论文"、"查论文"、"search papers"、"literature review"、"文献综述"、"影响因子"、"引用量"等场景时触发此 skill。
---
