---
name: ui-ux-pro-max
description: "UI/UX design intelligence and review support for web and mobile interfaces. Use when the task asks for UI/UX audit, accessibility or responsive review, design-system decisions, product-specific layout guidance, color/typography recommendations, chart UX, or detailed visual QA across stacks. Prefer frontend-design when the primary task is to implement production frontend code; use this skill as a reference/review layer when design judgment is the main need."
---
...
- **Stack**: Identify the target stack from the project or user request. This skill supports React, Next.js, Vue, Svelte, Astro, SwiftUI, React Native, Flutter, Nuxt, shadcn/ui, Tailwind, HTML/CSS, Three.js, and related UI stacks.
...
```bash
python3 "${CLAUDE_SKILL_DIR}/scripts/search.py" "<keyword>" --stack react-native
```
...
```bash
python3 "${CLAUDE_SKILL_DIR}/scripts/search.py" "list performance navigation" --stack react-native
```
