...
> 实时更新 · 最后更新：2026-05-09
>
> 本文档描述当前所有可用 Skills 及 Agent 的功能。新增或删除技能后应同步更新此文档。
>
> - **全局 Skills** → `~/.claude/skills/` — 所有项目自动加载
> - **项目专属 Skills** → `CC/.claude/skills/` — 仅在本项目下激活
> - **系统内置** — Claude Code 自带，无需文件

---

## 一、全局 Skills（24个，所有项目可用）
...
| **daily-plan-organizer** | 每日计划整理器。简报完成后询问用户安排，按上午/下午/晚间生成交互式HTML打卡页：拖拽排序、添加删除、完成归档。每日9:03紧接简报之后自动触发 | 今天安排, 计划清单, 每日计划, 打卡 |
...
## 二、CC 项目专属（2 Skills + 2 Agents）

### 学术 Skills

| Skill | 功能 | 触发关键词 |
|-------|------|-----------|
| **paper-search-download** | 学术论文搜索与下载，覆盖人文地理/社科全领域，支持中英文、影响因子、引用量查询 | 找论文, 搜文献, 下载论文, literature review |
| **research-paper-writer** | 社科/人文正式学术论文写作（人文地理/人口/经济/GIS），遵循中文核心期刊标准，作者-年份引用格式 | 写论文, 学术论文, 期刊论文 |

### 备考 Agents

| Agent | 功能 | 触发场景 |
|-------|------|---------|
| **civil-service-exam-hunan-advisor** | 湖南公务员考试顾问：国考/省考/选调的报名、备考、政策解读、岗位选择、面试技巧 | 湖南省考, 国考, 湖南选调 |
| **jiaoxi-exam-advisor** | 教师资格考试顾问：笔试内容、面试试讲、报名流程、认证政策 | 教资考试, 教师资格证 |
